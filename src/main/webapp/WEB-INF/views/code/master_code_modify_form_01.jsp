	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">
	        ...
	        <tr>	        	
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="prntMajCode" name="prntMajCode" style="width:100%" data-options="label:'<spring:message code="resc.label.prntMajCode"/>:',labelWidth:120" value="${cm001c.prntMajCode}">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">		        			            
	            </td>	            
