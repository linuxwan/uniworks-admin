	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">
	        ...
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="rescKey" name="rescKey" style="width:100%" data-options="label:'<spring:message code="resc.label.rescKey"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
	        ...
	        <tr>	        	
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="majCodeName" name="majCodeName" style="width:100%" data-options="label:'<spring:message code="resc.label.majCodeName"/>(${lang.rescKeyDesc}):',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="majCodeDesc" name="majCodeDesc" style="width:100%" data-options="label:'<spring:message code="resc.label.majCodeDesc"/>(${lang.rescKeyDesc}):',labelWidth:120">
		            </div>
	            </td>	            
	        </tr>
	        </c:forEach>
