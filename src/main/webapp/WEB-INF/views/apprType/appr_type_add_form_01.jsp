...
<title><spring:message code="resc.label.apprTypeAddForm"/></title>
	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">
	        ...
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="apprItemId" name="apprItemId" style="width:100%" data-options="label:'<spring:message code="resc.label.apprTypeId"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-datebox" id="createDate" name="createDate" style="width:100%" data-options="label:'<spring:message code="resc.label.crtDate"/>:',required:true,formatter:dashformatter,parser:dashparser,labelWidth:120">
		            </div>
	            </td>
	        </tr>
	        ...
	        <tr>	        	
	            <td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="apprItemName_<c:out value="${lang.rescKeyValue}"/>" name="apprItemName_<c:out value="${lang.rescKeyValue}"/>" style="width:100%" data-options="label:'<spring:message code="resc.label.apprTypeName"/>(${lang.rescKeyValue}):',required:true,labelWidth:120">
		            </div>
	            </td>	                 
	        </tr>
	        </c:forEach>
