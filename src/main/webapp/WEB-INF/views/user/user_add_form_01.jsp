    ...
    $(function(){
	    $('#btnSave').bind('click', function(){
	    	if($('#userAddForm').form('enableValidation').form('validate')) {  
	    		...
	    		var strUrl = '<c:out value="${contextPath}"/>/rest/user/create';
	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">
	        <tr>
	            ...
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="userId" name="userId" style="width:100%" data-options="label:'<spring:message code="resc.label.empNo"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">			        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="internalMailAddr" name="internalMailAddr" style="width:100%" data-options="label:'<spring:message code="resc.label.internalMailAddr"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="outsideMailAddr" name="outsideMailAddr" style="width:100%" data-options="label:'<spring:message code="resc.label.outsideMailAddr"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	        </tr>
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">			        	
		            <div style="margin-bottom:10px">
		                ...
		                <input class="easyui-validatebox" id="pswdInitIndcN" name="pswdInitIndc" type="radio" data-options="required:true" value="2" checked="checked"><spring:message code="resc.label.no"/>
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <spring:message code="resc.label.useIndc"/>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                <input class="easyui-validatebox" id="useIndcY" name="useIndc" type="radio" data-options="required:true" value="Y" checked="checked"><spring:message code="resc.label.yes"/>
