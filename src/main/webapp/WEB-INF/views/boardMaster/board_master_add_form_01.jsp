    ...
    $(function(){    	    	    	
	    ...
	    $('#btnSave').bind('click', function(){
	    	if($('#boardMasterAddForm').form('enableValidation').form('validate')) {
	    		...
	    		var strUrl = '<c:out value="${contextPath}"/>/rest/boardMaster/create';	    		    		
    ...
    function fnCheckedBoardTypeControl(boardType) {    	
    	...
    	switch(boardType) {
    		...
    		case 'B03':
    			...
    			fnCheckedRadioButtonById("anceIndcN"); fnDisabledRadioButtonById('anceIndc', true);
	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">			
	            ...
	            <td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">		                
		                ...
		                <c:forEach items="${boardTypeList}" var="boardType">
		                	<option value="${boardType.subCode}">${boardType.subCode}:${boardType.rescKeyDesc}</option>
		                </c:forEach>
		                </select>		 
		            </div>		            
	            </td>	            	           
	        ...
	        <tr>	        	
	        	<td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="boardId" name="boardId" style="width:100%" data-options="label:'<spring:message code="resc.label.boardId"/>:',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">		            
	            </td>	         	            
	        ...
	        <tr>	        	
	            <td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="boardName_<c:out value="${lang.rescKeyValue}"/>" name="boardName_<c:out value="${lang.rescKeyValue}"/>" style="width:100%" data-options="label:'<spring:message code="resc.label.boardName"/>(${lang.rescKeyValue}):',required:true,labelWidth:120">
		            </div>
	            </td>	                 
	        </tr>
	        </c:forEach>
