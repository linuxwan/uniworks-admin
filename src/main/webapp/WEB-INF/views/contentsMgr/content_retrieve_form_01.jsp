...
<title><spring:message code="resc.label.contentAddForm"/></title>
    ...
    $(function(){    	    	    	
	    ...
	    $('#btnModify').bind('click', function(){
	    	var url = "<c:out value="${contextPath}"/>/admin/boardMasterMgr/boardMasterModifyForm?coId=" + "${contentInfo.coId}" + "&cntnId=" + "${contentInfo.cntnId}";
	    	location.href = url;
		});
    ...
    function disableObjectChangeEnabled() {
    	fnDisabledRadioButtonById('cntnJointFlag', true);  
...
<body>
	<div class="easyui-panel" title="<spring:message code="resc.label.contentAddForm"/>" style="width:100%;max-width:100%;padding:10px 10px;">     
	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">			
	        ...
	        <tr>	        	
	        	<td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">		                
		                <select class="easyui-combobox" id="cntnType" name="cntnType" style="width:100%;" data-options="panelHeight:'auto',label:'<spring:message code="resc.label.cntnType"/>:',readonly:true,required:true,labelWidth:120">		                	
	        ...
	        <tr>	        	
	            <td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="cntnName_<c:out value="${nw031m.locale}"/>" name="cntnName_<c:out value="${nw031m.locale}"/>" style="width:100%" data-options="label:'<spring:message code="resc.label.cntnName"/>(${nw031m.locale}):',readonly:true,required:true,labelWidth:120" value="${nw031m.cntnName}">
		            </div>
	            </td>	                 
	        </tr>
	        </c:forEach>
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">	        				        
		            <div style="margin-bottom:10px">		                
		                <select class="easyui-combobox" id="cntnOfferType" name="cntnOfferType" style="width:100%;" data-options="panelHeight:'auto',label:'<spring:message code="resc.label.cntnOfferType"/>:',readonly:true,required:true,labelWidth:120">		                	
	            ...
	            <td style="width:50%;padding:0px 10px;">
	            	<div style="margin-bottom:10px">	
		            	...
		            	<tr>	
		            		...
		            		<td>            		               
		                	<input class="easyui-textbox" id="linkSysHost" name="linkSysHost" value="${contentInfo.linkSysHost}" style="width:63%" data-options="readonly:true,labelWidth:20"> :
		                	<input class="easyui-textbox" id="portNo" name="portNo" value="${contentInfo.portNo}" style="width:20%" data-options="readonly:true,labelWidth:45">
		                	</td>
		                </tr>
		                </table>		                
		            </div>			   		            		               			            
	        ...
	        <tr>	        	
	        	<td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="url" name="url" style="width:100%" data-options="label:'<spring:message code="resc.label.url"/>',readonly:true,labelWidth:120" value="${contentInfo.url}">
		            </div>
	            </td>	              	            
	        </tr>
	        <tr>	        	
	        	<td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="cntnDesc" name="cntnDesc" style="width:100%" data-options="label:'<spring:message code="resc.label.cntnDesc"/>',readonly:true,labelWidth:120" value="${contentInfo.cntnDesc}">
		            </div>
	            </td>	              	            
	        </tr>		
	        <tr>
