...
<title><spring:message code="resc.label.contentAddForm"/></title>
    ...
    $(function(){    	    	    	
    	...
    	$('#btnSave').bind('click', function(){
	    	if($('#contentAddForm').form('enableValidation').form('validate')) {
	    		disableObjectChangeEnabled();
	    		var formData = JSON.stringify($('#contentAddForm').serializeObject());
	    		var strUrl = '<c:out value="${contextPath}"/>/rest/contents/create';	    		    		
    ...
    function initialObjectValue() {
    	fnCheckedRadioButtonById("cntnJointFlagY");
    	disableObjectChangeEnabled();
    }
	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">			
	        <tr>
	            ...
	            <td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="cntnId" name="cntnId" style="width:100%" data-options="label:'<spring:message code="resc.label.cntnId"/>:',required:true,labelWidth:120">
		            </div>
	            </td>	            	            	          
	        </tr>
	        <tr>	        	
	        	<td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">		                
		                ...
		                <c:forEach items="${cntnTypeList}" var="cntnType">
		                	<option value="${cntnType.subCode}" >${cntnType.subCode}:${cntnType.rescKeyDesc}</option>
		                </c:forEach>
		                </select>		 
		            </div>		            
	            </td>
	            <td style="width:50%;padding:0px 10px;">
	            	<div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="masterId" name="masterId" style="width:60%" data-options="label:'<spring:message code="resc.label.masterId"/>:',readonly:true,labelWidth:120">
	        ...
	        <tr>	        	
	            <td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="cntnName_<c:out value="${lang.rescKeyValue}"/>" name="cntnName_<c:out value="${lang.rescKeyValue}"/>" style="width:100%" data-options="label:'<spring:message code="resc.label.cntnName"/>(${lang.rescKeyValue}):',required:true,labelWidth:120">
		            </div>
	            </td>	                 
	        </tr>
	        </c:forEach>
	        	...
	        	<td style="width:50%;padding:0px 10px;">	        				        
		            <div style="margin-bottom:10px">		                
		                ...
		                <c:forEach items="${cntnOfferTypeList}" var="cntnOfferType">
		                	<option value="${cntnOfferType.subCode}">${cntnOfferType.subCode}:${cntnOfferType.rescKeyDesc}</option>
		                </c:forEach>
		                </select>		 
		            </div>		        
	            </td>
	        ...
	        <tr>	        	
	        	<td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="url" name="url" style="width:100%" data-options="label:'<spring:message code="resc.label.url"/>',labelWidth:120">
		            </div>
	            </td>	              	            
	        </tr>	
	        <tr>	        	
	        	<td colspan="2" style="width:50%;padding:0px 10px;">
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id="cntnDesc" name="cntnDesc" style="width:100%" data-options="label:'<spring:message code="resc.label.cntnDesc"/>',labelWidth:120">
		            </div>
	            </td>	              	            
	        </tr>	
	        <tr>
