	...
	<jsp:include page="/WEB-INF/views/include/hidden_type_01.jsp"></jsp:include>
		<table style="width:100%">			
	        ...
	        <tr>
	        	<td style="width:50%;padding:0px 10px;">			        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id='roleName_<c:out value="${lang.rescKeyValue}"/>' name='roleName_<c:out value="${lang.rescKeyValue}"/>' style="width:100%" data-options="label:'<spring:message code="resc.label.roleName"/>(${lang.rescKeyValue}):',required:true,labelWidth:120">
		            </div>
	            </td>
	            <td style="width:50%;padding:0px 10px;">		        	
		            <div style="margin-bottom:10px">
		                <input class="easyui-textbox" id='roleDetl_<c:out value="${lang.rescKeyValue}"/>' name='roleDetl_<c:out value="${lang.rescKeyValue}"/>' style="width:100%" data-options="label:'<spring:message code="resc.label.roleDetl"/>(${lang.rescKeyValue}):',labelWidth:120">
		            </div>
	            </td>	            	            	          
	        </tr>	        	        
	        </c:forEach>
